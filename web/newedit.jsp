           ...
           <div class="col-10">
               <div class="container btn-block">
                   ...
                   <div class="alert alert-success  alert-dismissible fade show" role="alert">
                       New has been changed successfully!
                       ...
                       <div class="modal-dialog" role="document">
                           <div class="modal-content">
                               <form action="/deletenew" method="post">
                                   <input type="hidden" value="<%=news.getId()%>" name="new_id">
                   ...
                   <form action="/savenew" method="post">
                       ...
                       <div class="form-group">
                           ...
                           <input type="text" class="form-control" id="recipient-name" name="title" value="<%=news.getTitle()%>">
                       </div>
                       <div class="form-group">
                           <label>
                               Short content :
                           </label>
                           <textarea type="text" class="form-control" id="message-text" name="short_content" rows="5"><%=news.getShort_content()%> </textarea>
                       </div>
                       <div class="form-group">
                           <label>
                               Content:
                           </label>
                           <textarea type="text" class="form-control" id="content-text" name="content" rows="10"><%=news.getContent()%> </textarea>
                       </div>
                       <div class="form-group">
                           ...
                           <select class="form-control" name="language">
                               ...
                               %>
                               <option value="<%=l.getId()%>"  <%  if(l.getId() == news.getLanguage().getId()) {out.print("selected");};%>>
                                   <%=l.getName()%>
                               </option>
                               <%
                                   }
                       ...
                       <div class="form-group">
                           ...
                           <select class="form-control" name="publication">
                               ...
                               %>
                               <option value="<%=p.getId()%>" <%  if(p.getId() == news.getPublication().getId()) {out.print("selected");};%>>
                                   <%=p.getName()%>
                               </option>
                               <%
                                   }
                       ...
                       <div class="form-group">
                           ...
                           <select class="form-control" name="category">
                               ...
                               %>
                               <option value="<%=c.getId()%>" <%  if(c.getId() == news.getCategory().getId()) {out.print("selected");};%>>
                                   <%=c.getName()%>
                               </option>
                               <%
                                   }
                       ...
                       <div class="form-group">
                           ...
                           <input type="text" class="form-control" id="pic_url" name="url" value="<%=news.getPicture_url()%>">
                       </div>
