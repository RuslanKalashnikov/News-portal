           ...
           <div class="col-10">
               <div class="container btn-block">
                   <div style="display:  flex;">
                       <% Languages lang = (Languages) request.getAttribute("language");
                       if (lang != null) {
                   ...
                   <div class="modal fade" id="deleteHotelModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                       <div class="modal-dialog" role="document">
                           <div class="modal-content">
                               <form action="/deletelang" method="post">
                                   <input type="hidden" value="<%=lang.getId()%>" name="lang_id">
                   ...
                   <form action="/savelang" method="post">
                       <input type="hidden" value="<%=lang.getId()%>" name="lang_id">
                       <div class="form-group">
                           <label>
                               Name :
                           </label>
                           <input type="text" name="lang_name" class="form-control" value="<%=lang.getName()%>">
                       </div>
                       <div class="form-group">
                           <label>
                               Code :
                           </label>
                           <input type="text" name="code" class="form-control" value="<%=lang.getCode()%>">
                       </div>
                       <div class="form-group">
